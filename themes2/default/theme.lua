...
theme.wallpaper =  gfs.get_configuration_dir() .. "themes/default/MountainDark.jpg"
-- theme.wallpaper = "~/.config/awesome/themes/default/MountainDark.jpg"
----- HotKeys Widget -----
