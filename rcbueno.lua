...
awful.keyboard.append_global_keybindings({
    awful.key(
        { modkey, }, "w", function () awful.util.spawn("firefox") end,
...
awful.keyboard.append_global_keybindings({
    awful.key(
        { modkey }, "e", function () awful.util.spawn("nautilus") end,
...
beautiful.notification_bg = '#262627'
...
awful.keyboard.append_global_keybindings({
    awful.key(
    { }, "XF86MonBrightnessUp", function() os.execute("xbacklight -inc 5")
        -- naughty.notify { text = "brightness up" } 
        end,
        {description = "+10%", group = "hotkeys"}),
    awful.key(
    { }, "XF86MonBrightnessDown", function() os.execute("xbacklight -dec 5")
        --naughty.notify { text = "brightness down" } 
        end,
        {description = "+10%", group = "hotkeys"}),
    awful.key(
    { }, "XF86AudioRaiseVolume", function() os.execute("amixer -q sset Master 10%+")
        awful.util.spawn("amixer -c 0 sset Master 5%+", false) end),
    awful.key(
...
--awful.spawn.with_shell("polybar awesome &")
